  ...
  10[v_5] -
  obj[l_9] --< P(abc) >--> 10[v_5]
  obj[l_9] --< V(null) >--> obj[l_10]
  10[v_6] -
  obj[l_10] --< P(null) >--> 10[v_6]
  ...
  foo(...)[l_1] --< D >--> $v3[l_2]
  $v3[l_2] -
  10[v_3] --< Arg(1) >--> foo(...)[l_3]
  "abc"[v_4] --< Arg(2) >--> foo(...)[l_3]
  true[v_5] --< Arg(3) >--> foo(...)[l_3]
  foo(...)[l_3] --< Call >--> $v1[f_1]
  foo(...)[l_3] --< Call >--> $v2[f_2]
  foo(...)[l_3] --< D >--> $v4[l_4]
  $v4[l_4] -
