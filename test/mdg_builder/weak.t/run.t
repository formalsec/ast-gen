...
Graph.js MDG Builder: week method call
  ...
  [[function]] $v2[#11] --< Param(1) >--> x1[#13]
  this[#12] -
  x1[#13] -
  $v1[#14] --< P(foo) >--> [[function]] $v2[#11]
  ...
  [[function]] $v4[#16] --< Param(0) >--> this[#17]
  [[function]] $v4[#16] --< Param(1) >--> y1[#18]
  [[function]] $v4[#16] --< Param(2) >--> y2[#19]
  [[function]] $v4[#16] --< Param(3) >--> y3[#20]
  this[#17] -
  y1[#18] -
  y2[#19] -
  y3[#20] -
  $v3[#21] --< P(bar) >--> [[function]] $v4[#16]
  $v3[#21] --< Arg(0) >--> obj.foo(...)[#24]
  $v3[#21] --< Arg(0) >--> obj.bar(...)[#30]
  $v3[#21] --< Arg(0) >--> obj.baz(...)[#34]
  10[#22] --< Arg(1) >--> obj.foo(...)[#24]
  obj.foo[#23] -
  obj.foo(...)[#24] --< Call >--> [[function]] $v2[#11]
  ...
  obj.bar[#29] -
  obj.bar(...)[#30] --< Call >--> [[function]] $v4[#16]
...
Graph.js MDG Builder: week function call
  ...
  [[function]] $v2[#13] --< Param(1) >--> y1[#15]
  [[function]] $v2[#13] --< Param(2) >--> y2[#16]
  [[function]] $v2[#13] --< Param(3) >--> y3[#17]
  this[#14] -
  y1[#15] -
  y2[#16] -
  y3[#17] -
  10[#18] --< Arg(1) >--> foo(...)[#19]
  foo(...)[#19] --< Call >--> [[function]] $v1[#10]
  foo(...)[#19] --< Call >--> [[function]] $v2[#13]
  foo(...)[#19] --< D >--> $v3[#20]
  $v3[#20] -
  10[#21] --< Arg(1) >--> foo(...)[#24]
  "abc"[#22] --< Arg(2) >--> foo(...)[#24]
  true[#23] --< Arg(3) >--> foo(...)[#24]
  foo(...)[#24] --< Call >--> [[function]] $v1[#10]
  foo(...)[#24] --< Call >--> [[function]] $v2[#13]
  foo(...)[#24] --< D >--> $v4[#25]
  $v4[#25] -
