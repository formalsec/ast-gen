  ...
  bar[f_3] --< Param(1) >--> w1[p_1]
  bar[f_3] --< Param(2) >--> w2[p_2]
  bar[f_3] --< Param(3) >--> w3[p_3]
  this[p_0] -
  w1[p_1] -
  w2[p_2] -
  w3[p_3] -
  bar[f_4] --< Param(0) >--> this[p_0]
  bar[f_4] --< Param(1) >--> y1[p_1]
  this[p_0] -
  y1[p_1] -
  foo[f_5] --< Param(0) >--> this[p_0]
  foo[f_5] --< Param(1) >--> z1[p_1]
  foo[f_5] --< Param(2) >--> z2[p_2]
  foo[f_5] --< Param(3) >--> z3[p_3]
  this[p_0] -
  z1[p_1] -
  z2[p_2] -
  z3[p_3] -
  ...
  qux[f_5] --< Param(0) >--> this[p_0]
  qux[f_5] --< Param(1) >--> w1[p_1]
  this[p_0] -
  w1[p_1] -
  ...
  baz[f_4] --< Param(0) >--> this[p_0]
  baz[f_4] --< Param(1) >--> z1[p_1]
  baz[f_4] --< [[RefRet]] >--> z1[p_1]
  this[p_0] -
  z1[p_1] -
  qux[f_5] --< Param(0) >--> this[p_0]
  qux[f_5] --< Param(1) >--> w1[p_1]
  qux[f_5] --< [[RefRet]] >--> w1[p_1]
  this[p_0] -
  w1[p_1] -
  ...
  foo(...)[l_1] --< Call >--> foo[f_2]
  foo(...)[l_1] --< Ret >--> $v1[l_2]
  $v1[l_2] -
  bar(...)[l_3] --< Call >--> bar[f_3]
  bar(...)[l_3] --< Ret >--> $v2[l_4]
  $v2[l_4] -
  bar(...)[l_5] --< Call >--> bar[f_3]
  bar(...)[l_5] --< Ret >--> $v3[l_6]
  $v3[l_6] -
  foo(...)[l_7] --< Call >--> foo[f_2]
  foo(...)[l_7] --< Ret >--> $v4[l_8]
  $v4[l_8] -
  baz(...)[l_9] --< Ret >--> $v5[l_10]
  $v5[l_10] -
