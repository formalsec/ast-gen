  ...
  $v1[f_2] --< Param(0) >--> this[p_0]
  $v1[f_2] --< Param(1) >--> x1[p_1]
  this[p_0] --< [[RefArg]] >--> obj[l_3]
  x1[p_1] --< [[RefArg]] >--> [[literal]]
  obj[l_2] --< [[RefParent(foo)]] >--> obj[l_1]
  obj[l_2] --< P(foo) >--> $v1[f_2]
  obj[l_2] --< V(bar) >--> obj[l_3]
  $v2[f_3] --< Param(0) >--> this[p_0]
  $v2[f_3] --< Param(1) >--> y1[p_1]
  $v2[f_3] --< Param(2) >--> y2[p_2]
  $v2[f_3] --< Param(3) >--> y3[p_3]
  this[p_0] --< [[RefArg]] >--> obj[l_3]
  y1[p_1] --< [[RefArg]] >--> [[literal]]
  y2[p_2] --< [[RefArg]] >--> [[literal]]
  y3[p_3] --< [[RefArg]] >--> [[literal]]
  obj[l_3] --< [[RefParent(bar)]] >--> obj[l_2]
  obj[l_3] --< P(bar) >--> $v2[f_3]
  ...
  obj.foo[l_4] -
  obj.foo(...)[l_5] --< Call >--> $v1[f_2]
  obj.foo(...)[l_5] --< Ret >--> $v3[l_6]
  $v3[l_6] -
  obj.bar[l_7] -
  obj.bar(...)[l_8] --< Call >--> $v2[f_3]
  obj.bar(...)[l_8] --< Ret >--> $v4[l_9]
  $v4[l_9] -
  obj.bar(...)[l_10] --< Call >--> $v2[f_3]
  obj.bar(...)[l_10] --< Ret >--> $v5[l_11]
  $v5[l_11] -
  obj.foo(...)[l_12] --< Call >--> $v1[f_2]
  ...
  $v4[l_9] -
  $v5[l_10] --< D >--> obj.*[l_4]
  obj.*(...)[l_11] --< Call >--> $v1[f_2]
  obj.*(...)[l_11] --< Call >--> $v2[f_3]
